package com.ftn.sbnz.service.feature.event.service.impl;

import com.ftn.sbnz.service.core.other.exception.StartDateIsAfterEndDateException;
...
import com.ftn.sbnz.service.feature.event.mapper.EventMapper;
import com.ftn.sbnz.service.feature.event.model.EventEntity;
import com.ftn.sbnz.service.feature.event.repository.EventRepository;
import com.ftn.sbnz.service.feature.event.service.EventService;
...
public class DefaultEventService implements EventService {
    ...
    private void validEventUpdateRequest(EventEntity eventToUpdate, CreateUpdateEventRequestDto dto) {
        if (dto.getTotalSeats() < eventToUpdate.getNumberOfAvailableSeats()) {
