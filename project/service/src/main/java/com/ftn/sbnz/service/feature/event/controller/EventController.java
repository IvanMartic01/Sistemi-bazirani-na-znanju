package com.ftn.sbnz.service.feature.event.controller;
...
public class EventController {
    ...
    public Collection<EventResponseDto> getVisitedEvent() {
        return eventService.getAllVisitorVisitedEvents();
    }

    @GetMapping("/visitor-reserved")
    public Collection<EventResponseDto> getReservedEvent() {
